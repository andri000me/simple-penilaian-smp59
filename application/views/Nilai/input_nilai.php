                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <form class="form-horizontal" role="form" action="<?= base_url('app/nilai/insert') ?>" method="POST">
                                                ...
                                                <div class="col-md-10">
                                                    <select name="nis" class="form-control select2" required>
                                                        ...
                                                        <?php foreach ($siswa as $key => $value): ?>
                                                            <option value="<?= $value->NIS ?>"><?= $value->NIS." (".$value->nama.")" ?></option>
                                                        <?php endforeach ?>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <select name="kelas" class="form-control select2" required>
                                                        ...
                                                        ?>  
                                                        <option value="<?= $arrayKelas[$i] ?>"><?= $arrayKelas[$i] ?></option>  
                                                        <?php } ?>
                                            ...
                                            <h4 class="page-header">Input Data Nilai</h4>
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">Pendidikan Agama</label>
                                                <div class="col-md-4">
                                                    <input type="number" class="form-control"  name="pendidikan_agama" required max="100" min="0">
                                                </div>

                                                <label class="col-md-2 control-label">PKN</label>
                                                <div class="col-md-4">
                                                    <input type="number" class="form-control"  name="pendidikan_kewarganegaraan" required max="100" min="0">
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="number" class="form-control"  name="bahasa_indonesia" required max="100" min="0">
                                                </div>

                                                <label class="col-md-2 control-label">Bahasa Inggris</label>
                                                <div class="col-md-4">
                                                    <input type="number" class="form-control"  name="bahasa_inggris" required max="100" min="0">
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="number" class="form-control"  name="matematika" required max="100" min="0">
                                                </div>

                                                <label class="col-md-2 control-label">IPA</label>
                                                <div class="col-md-4">
                                                    <input type="number" class="form-control"  name="ilmu_pengetahuan_alam" required max="100" min="0">
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="number" class="form-control"  name="ilmu_pengetahuan_sosial" required max="100" min="0">
                                                </div>

                                                <label class="col-md-2 control-label">Seni Budaya</label>
                                                <div class="col-md-4">
                                                    <input type="number" class="form-control"  name="seni_budaya" required max="100" min="0">
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="number" class="form-control"  name="penjaskes" required max="100" min="0">
                                                </div>

                                                <label class="col-md-2 control-label">TIK</label>
                                                <div class="col-md-4">
                                                    <input type="number" class="form-control"  name="tik" required max="100" min="0">
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="number" class="form-control"  name="plkj" required max="100" min="0">
                                                </div>

                                                <label class="col-md-2 control-label">Tata Busana</label>
                                                <div class="col-md-4">
                                                    <input type="number" class="form-control"  name="tata_busana" required max="100" min="0">
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="number" class="form-control"  name="na" id="na" required max="100" min="0" readonly placeholder="Nilai Akhir">
                                                </div>
                                            </div>
