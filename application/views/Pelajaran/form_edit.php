                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <form class="form-horizontal" role="form" action="<?= base_url('app/pelajaran/update') ?>" method="POST">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" name="mata_pelajaran" class="form-control" placeholder="Mata Pelajaran" required value="<?= $mata_pelajaran ?>">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">KKM</label>
                                                <div class="col-md-10">
                                                    <input type="number" class="form-control" placeholder="KKM" name="kkm" required max="100" min="0" value="<?= $kkm?>">
                                                </div>
                                            </div>
